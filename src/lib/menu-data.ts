...
const pizzaSizeModifier: ModifierGroup = {
  ...
  options: [
    ...
    { id: 'size-12', name: '12" Medium', price: 3.00 },
    { id: 'size-15', name: '15" Large', price: 6.00 },
    { id: 'size-18', name: '18" Extra Large', price: 9.00 },
  ],
}
...
const pizzaCrustModifier: ModifierGroup = {
  ...
  options: [
    ...
    { id: 'crust-deep', name: 'Deep Pan', price: 0.50 },
    { id: 'crust-stuffed', name: 'Stuffed Crust', price: 1.50 },
  ],
}
...
const pizzaExtrasModifier: ModifierGroup = {
  ...
  options: [
    ...
    { id: 'extra-jalapenos', name: 'Jalapeños', price: 0.50 },
    { id: 'extra-olives', name: 'Black Olives', price: 0.50 },
    { id: 'extra-mushrooms', name: 'Mushrooms', price: 0.50 },
    { id: 'extra-pepperoni', name: 'Pepperoni', price: 1.00 },
    { id: 'extra-sweetcorn', name: 'Sweetcorn', price: 0.50 },
  ],
}
...
const pizzaSauceModifier: ModifierGroup = {
  ...
  options: [
    ...
    { id: 'sauce-peri', name: 'Peri Peri', price: 0.50 },
  ],
}
...
const burgerExtrasModifier: ModifierGroup = {
  ...
  max: 4,
  options: [
    { id: 'b-extra-cheese', name: 'Extra Cheese', price: 0.50 },
    { id: 'b-extra-bacon', name: 'Bacon', price: 1.00 },
    { id: 'b-extra-jalapenos', name: 'Jalapeños', price: 0.50 },
...
const drinkSizeModifier: ModifierGroup = {
  ...
  options: [
    ...
    { id: 'drink-bottle', name: 'Bottle (1.5L)', price: 1.00 },
  ],
}
...
export const products: Product[] = [
  // PIZZAS
  {
    id: 'american-hot',
    name: 'American Hot',
    description: 'Spicy beef, jalapeños, red onions and green peppers on a tangy tomato sauce base with mozzarella cheese',
    price: 8.99,
    image: '/images/Pizza/American hot.avif',
    category: 'pizza',
    popular: true,
    available: true,
    modifiers: [pizzaSizeModifier, pizzaCrustModifier, pizzaSauceModifier, pizzaExtrasModifier],
    allergens: ['Gluten', 'Dairy', 'Soya'],
  },
  {
    id: 'cheese-deluxe',
    name: 'Cheese Deluxe',
    description: 'A cheese lover\'s dream — loaded with mozzarella, cheddar and parmesan on a classic tomato base',
    price: 8.99,
  ...
  },
  {
    id: 'chicken-tikka',
    name: 'Chicken Tikka',
    description: 'Tender tikka chicken with peppers, red onions and a drizzle of mint yoghurt on a spiced tomato base',
    price: 9.99,
  ...
  },
  {
    id: 'farm-house',
    name: 'Farm House',
    description: 'Mushrooms, sweetcorn, peppers and red onions on a rich tomato sauce with mozzarella',
    price: 8.99,
  ...
  },
  {
    id: 'hawaiian',
    name: 'Hawaiian',
    description: 'Classic combination of ham and pineapple on a tomato sauce base with melted mozzarella cheese',
    price: 8.99,
  ...
  },
  {
    id: 'hot-spicy',
    name: 'Hot & Spicy',
    description: 'Spicy chicken, jalapeños, red chillies and peppers on a fiery tomato base with extra mozzarella',
    price: 9.99,
  ...
  },
  {
    id: 'margherita',
    name: 'Margherita',
    description: 'The Italian classic — fresh tomato sauce with mozzarella and a hint of basil',
    price: 7.99,
  ...
  },
  {
    id: 'meat-feast',
    name: 'Meat Feast',
    description: 'Loaded with pepperoni, beef mince, chicken, ham and sausage on a rich tomato base',
    price: 10.99,
  ...
  },
  {
    id: 'new-yorker',
    name: 'New Yorker',
    description: 'Big New York slices packed with pepperoni, beef and green peppers on a classic tomato base',
    price: 10.99,
  ...
  },
  {
    ...
    description: 'Double pepperoni layered on a zesty tomato sauce with mozzarella — a true classic',
    price: 9.99,
  ...
  },
  {
    ...
    description: 'Sizzling pepperoni with jalapeños and extra cheese on a spiced tomato sauce',
    price: 10.99,
  ...
  },
  {
    ...
    description: 'Prawns, tuna and sweetcorn on a creamy garlic base with mozzarella cheese',
    price: 11.99,
  ...
  },
  {
    ...
    description: 'Marinated tandoori chicken with peppers and onions on a spiced tomato base',
    price: 9.99,
  ...
  },
  {
    id: 'texas-bbq',
    name: 'Texas BBQ',
    description: 'Smoky BBQ chicken, beef and onions on a rich BBQ sauce base with mozzarella',
    price: 10.99,
  ...
  },
  {
    id: 'tuna-delight',
    name: 'Tuna Delight',
    description: 'Tuna, sweetcorn and red onions on a creamy tomato base with mozzarella',
    price: 9.99,
  ...
  },
  {
    ...
    description: 'Roasted peppers, mushrooms, jalapeños and sweetcorn on a spicy tomato base — vegetarian friendly',
    price: 8.99,
  ...
  },
  {
    id: 'veggie-special',
    name: 'Veggie Special',
    description: 'Mushrooms, peppers, red onions, sweetcorn and olives on a classic tomato base',
    price: 8.99,
  ...
  // PIZZA CRAZY DEALS
  {
    ...
    description: 'Choose any 2 personal 9-inch pizzas from our full menu. Mix and match your favourites!',
    price: 14.99,
  ...
  },
  {
    ...
    description: 'Choose any 2 medium 12-inch pizzas from our full menu. Perfect for sharing!',
    price: 19.99,
  ...
  },
  {
    ...
    description: 'Choose any 2 large 15-inch pizzas from our full menu. Great value for hungry families!',
    price: 24.99,
  ...
  },
  {
    ...
    description: 'Choose any 2 extra-large 18-inch pizzas. The ultimate pizza feast for the whole family!',
    price: 29.99,
  ...
  // PIZZA MEALS
  {
    id: 'meal-deal-1',
    name: 'Meal Deal 1',
    description: '9" pizza + side of fries + regular drink. A complete meal at an unbeatable price',
    price: 12.99,
  ...
  },
  {
    id: 'meal-deal-2',
    name: 'Meal Deal 2',
    description: '12" pizza + 2 sides + 2 drinks. Perfect for couples or sharing with a friend',
    price: 17.99,
  ...
  },
  {
    id: 'big-meal-deal',
    name: 'Big Meal Deal',
    description: '15" pizza + 3 sides + 3 drinks. A hearty meal that\'s perfect for the family',
    price: 24.99,
  ...
  },
  {
    ...
    description: '18" pizza + 4 sides + 4 drinks. The ultimate family feast for everyone to enjoy!',
    price: 34.99,
  ...
  },
  {
    id: 'party-pack',
    name: 'Party Pack',
    description: '2 x 15" pizzas + garlic bread + 6 dips + 6 drinks. Feed the whole party!',
    price: 49.99,
  ...
  },
  {
    ...
    description: '12" pizza + 2 ice cream desserts of your choice. For those who love pizza AND dessert!',
    price: 18.99,
  ...
  // BURGERS
  {
    ...
    description: 'Double smash patties with crispy bacon, BBQ sauce, cheese and pickles in a toasted brioche bun',
    price: 8.99,
  ...
  },
  {
    id: 'cheeseburger',
    name: 'Cheeseburger',
    description: 'Classic beef patty with melted cheese, lettuce, tomato, onion and burger sauce',
    price: 5.99,
  ...
  },
  {
    ...
    description: 'Crispy golden chicken fillet with lettuce, mayo and pickles in a soft bun',
    price: 6.99,
  ...
  },
  {
    ...
    description: 'Smashed beef patty with cheese, caramelised onions and signature sauce in a toasted bun',
    price: 7.99,
  ...
  },
  {
    ...
    description: 'Two beef patties, double cheese, lettuce, tomato, onion and burger sauce — double the deliciousness!',
    price: 7.99,
  ...
  },
  {
    ...
    description: 'A massive half-pound beef patty with lettuce, tomato, cheese and our special sauce',
    price: 10.99,
  ...
  },
  {
    ...
    description: 'A juicy quarter-pound beef patty with all the classic burger toppings',
    price: 7.99,
  ...
  },
  {
    ...
    description: 'Crispy spiced chicken fillet with peri peri mayo, fresh chillies and pickles in a soft bun',
    price: 7.99,
  ...
  },
  {
    id: 'veggie-burger',
    name: 'Veggie Burger',
    description: 'A flavourful plant-based patty with lettuce, tomato, cheese and burger sauce',
    price: 6.99,
  ...
  // KEBABS
  {
    id: 'chicken-kebab',
    name: 'Chicken Kebab',
    description: 'Marinated grilled chicken served with salad, garlic sauce and pitta bread',
    price: 8.99,
  ...
  },
  {
    ...
    description: 'Tender sliced lamb doner with fresh salad, chilli sauce and pitta bread',
    price: 8.99,
  ...
  // KEBAB PIZZA SPECIALS
  {
    ...
    description: 'A unique fusion of doner kebab meat on a pizza base with garlic sauce and mozzarella',
    price: 11.99,
  ...
  },
  {
    ...
    description: 'Your choice of lamb, chicken or mixed doner on a pizza base with salad sauce and cheese',
    price: 12.99,
    image: '/images/Kebab Pizza specials/Lamb or chicken or mixed meat doner kebab pizza.avif',
    category: 'kebab-pizza',
    available: true,
    modifiers: [pizzaSizeModifier, pizzaCrustModifier],
    allergens: ['Gluten', 'Dairy', 'Sesame'],
  ...
  // WRAPS
  {
    ...
    description: 'Grilled chicken doner with fresh salad, garlic mayo and chilli sauce in a warm tortilla',
    price: 6.99,
  ...
  },
  {
    ...
    description: 'Tender lamb doner with crisp salad, garlic mayo and chilli sauce wrapped in a soft tortilla',
    price: 6.99,
  ...
  },
  {
    ...
    description: 'A mix of chicken and lamb doner with salad, garlic mayo and chilli sauce in a warm tortilla',
    price: 7.49,
  ...
  // SIDES
  {
    ...
    description: 'Crispy golden mozzarella balls with a gooey melted cheese centre, served with dipping sauce',
    price: 4.99,
  ...
  },
  {
    ...
    description: 'Classic mozzarella sticks breaded to perfection, served with marinara dipping sauce',
    price: 4.99,
  ...
  },
  {
    ...
    description: 'Tender chicken nuggets with a crispy golden coating, served with your choice of dipping sauce',
    price: 4.49,
  ...
  },
  {
    ...
    description: 'Fiery hot chicken wings marinated in our special spice blend, served with cooling dip',
    price: 5.99,
  ...
  },
  {
    ...
    description: 'Beer-battered crispy onion rings, perfectly golden and served with garlic mayo',
    price: 3.99,
  ...
  },
  {
    ...
    description: 'Spiced mutton mince wrapped in crispy pastry, deep fried to golden perfection',
    price: 3.99,
  ...
  },
  {
    ...
    description: 'Mixed vegetable rolls wrapped in crispy pastry — a tasty vegetarian option',
    price: 3.49,
  ...
  },
  {
    ...
    description: 'Warm baguette slices brushed with garlic butter, toasted to perfection',
    price: 2.99,
  ...
  },
  {
    ...
    description: 'Crispy pastry triangles filled with spiced minced meat and vegetables',
    price: 3.49,
  ...
  },
  {
    ...
    description: 'Light and crispy samosas filled with spiced potatoes, peas and vegetables',
    price: 3.49,
  ...
  },
  {
    ...
    description: 'Smoky BBQ glazed chicken wings, sticky and finger-licking good',
    price: 4.99,
  ...
  },
  {
    ...
    description: 'Crispy breaded chicken strips, ideal for dipping in your favourite sauce',
    price: 4.99,
  ...
  },
  {
    id: 'cheesy-chips',
    name: 'Cheesy Chips',
    description: 'Golden fries topped with melted cheese sauce — irresistibly good',
    price: 3.49,
  ...
  },
  {
    ...
    description: 'Bite-sized crispy chicken pieces — perfect for snacking or sharing',
    price: 3.99,
  ...
  },
  {
    ...
    description: 'Chunky seasoned potato wedges, crispy on the outside and fluffy in the middle',
    price: 3.49,
  ...
  },
  {
    id: 'supreme-salad',
    name: 'Supreme Salads',
    description: 'Fresh mixed salad with lettuce, tomatoes, cucumber, onions and dressing',
    price: 3.99,
  ...
  // KIDS MEALS
  {
    ...
    description: 'A smaller cheeseburger with kids fries and a drink — perfect for little ones',
    price: 5.99,
  ...
  // LUNCH TIME OFFERS
  {
    id: 'lunch-kebab',
    name: 'Any Kebab Meal',
    description: 'Choice of chicken or lamb kebab + fries + regular drink. Available Mon-Fri 11am-4pm',
    price: 9.99,
  ...
  },
  {
    ...
    description: '12" pizza + fries + regular drink. Available Mon-Fri 11am-4pm',
    price: 14.99,
  ...
  },
  {
    ...
    description: 'Cheeseburger + fries + regular drink. Available Mon-Fri 11am-4pm',
    price: 7.99,
  ...
  },
  {
    ...
    description: 'Chicken or lamb wrap + fries + regular drink. Available Mon-Fri 11am-4pm',
    price: 8.99,
  ...
  },
  {
    ...
    description: 'Double cheeseburger + fries + regular drink. Available Mon-Fri 11am-4pm',
    price: 9.49,
  ...
  // DESSERTS
  {
    ...
    description: "America's most loved ice cream — choose from a range of indulgent flavours",
    price: 4.99,
  ...
  },
  {
    id: 'carrot-cake',
    name: 'Carrot Cake',
    description: 'Moist homemade carrot cake with cream cheese frosting — a classic treat',
    price: 3.49,
  ...
  },
  {
    ...
    description: 'Rich and decadent chocolate fudge cake with chocolate ganache — pure indulgence',
    price: 3.49,
  ...
  },
  {
    ...
    description: 'Premium luxury ice cream in a variety of classic and indulgent flavours',
    price: 4.99,
  ...
  },
  {
    ...
    description: 'Creamy New York style cheesecake with a fresh strawberry topping on a biscuit base',
    price: 3.99,
  ...
  // DIPS
  {
    id: 'bbq-dip',
    name: 'BBQ Dip',
    description: 'Smoky and sweet BBQ dipping sauce — pairs perfectly with wings and dippers',
    price: 0.99,
  ...
  },
  {
    id: 'garlic-mayo',
    name: 'Garlic Mayo',
    description: 'Creamy garlic mayonnaise — the perfect dip for fries and kebabs',
    price: 0.99,
  ...
  },
  {
    id: 'spicy-mayo',
    name: 'Spicy Mayo',
    description: 'Creamy mayonnaise with a fiery chilli kick — not for the faint hearted!',
    price: 0.99,
...
export const deliveryZones = [
  { postcode: 'TW18', minOrder: 10.00, deliveryFee: 1.99 },
  { postcode: 'TW19', minOrder: 10.00, deliveryFee: 1.99 },
  { postcode: 'TW20', minOrder: 12.00, deliveryFee: 2.49 },
  { postcode: 'KT16', minOrder: 12.00, deliveryFee: 2.49 },
  { postcode: 'GU25', minOrder: 15.00, deliveryFee: 2.99 },
]
