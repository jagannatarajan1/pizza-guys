...
const SLIDES: Slide[] = [
  {
    ...
    accent: "Real Good.",
    subtitle:
      "Freshly made with premium ingredients — delivered hot to your door in 30–45 minutes.",
    cta: "Order Now",
    ctaHref: "/menu",
    cta2: "View Offers",
    cta2Href: "/offers",
  ...
  },
  {
    ...
    accent: "Burgers",
    subtitle:
      "Juicy, char-grilled beef patties stacked high with melted cheese and all the trimmings.",
    cta: "View Burgers",
        ...
        {SLIDES.map((_, i) => (
          <button
            ...
            style={{
              ...
              borderRadius: "4px",
              background:
                i === index ? "var(--brand-accent)" : "rgba(255,255,255,0.35)",
            }}
          />
        ))}
      </div> */}
