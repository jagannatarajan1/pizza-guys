...
export default function BrandLogo({ size = 'md', className = '' }: Props) {
  ...
  return (
    <Link href="/" className={`flex items-center gap-2.5 shrink-0 group ${className}`}>
      <div className={`${dim} bg-[#FFD700] rounded-full flex items-center justify-center font-black text-[#111] text-base group-hover:scale-110 transition-transform duration-200 shrink-0`}>
        PG
      </div>
