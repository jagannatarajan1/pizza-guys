    ...
    <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="space-y-6 text-sm text-gray-700 leading-relaxed">
        {[
          ...
          { title: '3. Cookies', body: 'Our website uses cookies to enhance your browsing experience. Cookies help us remember your basket, preferences, and login status. You can disable cookies in your browser settings, though some features may not work properly.' },
          ...
          { title: '6. Your Rights', body: 'Under GDPR, you have the right to access, correct, delete, and port your personal data. You also have the right to object to processing and to withdraw consent. Contact us at info@pizzaguys.co.uk to exercise these rights.' },
          ...
          { title: '8. Contact', body: 'For privacy-related queries, contact our data controller at info@pizzaguys.co.uk or write to: Pizza Guys, 209 Laleham Road, Staines-upon-Thames, Surrey, TW18 2EA.' },
        ].map((s) => (
          <div key={s.title}>
